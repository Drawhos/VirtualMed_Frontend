  ...
  scheduledAt: z
    ...
    .refine(
      (date) => {
        ...
        return selectedDate > new Date() && selectedDate <= oneYearFromNow;
      },
      { message: "La fecha debe estar entre hoy y 1 año en el futuro" }
    ),
  durationMinutes: z
    .number()
    .min(20, { message: "La duración mínima es 20 minutos" })
  ...
  const onSubmit = async (values: AppointmentFormValues) => {
    ...
    try {
      ...
      const appointmentData = {
        ...
        doctorId: null, // El backend debería asignar el doctorId basado en el token
